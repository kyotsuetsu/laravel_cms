<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
              ...
              <x-input-label id="language_level" class="block mt-1 w-full" :value="old('language_level')" required />

              <div class="mb-3 xl:w-96">
                <select  data-te-select-init name="language_level">
         ...
         <!--Level -->
        <div class="mt-4">
              <x-input-label for="talk_length" :value="__('talk_length')" />
              <x-input-label id="talk_length" class="block mt-1 w-full" :value="old('talk_length')" required />

              <div class="mb-3 xl:w-96">
                <select  data-te-select-init name="talk_length">
...
@if (Route::has('login'))
    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
        @auth
          　<a href="{{ url('/matching') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Matching</a>
        @else
